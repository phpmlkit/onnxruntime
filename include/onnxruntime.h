...
struct OrtApi {
    ...
    OrtStatus*(* CreateValue)(const OrtValue* const* values, size_t num_values, enum ONNXType value_type, OrtValue** out);
    OrtStatus*(* CreateOpaqueValue)(char* domain_name, char* type_name, void* data_container, size_t data_container_size, OrtValue** out);
    ...
    OrtStatus*(* SessionOptionsAppendExecutionProvider_TensorRT)(OrtSessionOptions* options, int device_id);
